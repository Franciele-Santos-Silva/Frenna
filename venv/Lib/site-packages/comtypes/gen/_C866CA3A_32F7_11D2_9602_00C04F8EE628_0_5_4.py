...
__all__ = [
    'SPEI_START_SR_STREAM', 'SRSInactive', 'SpeechTokenKeyAttributes',
    ...
    'DISPID_SVSPhonemeId', 'DISPID_SLPsItem',
    ...
    'SpeechRunState', 'DISPID_SpeechRecoResult', 'SP_VISEME_20',
    'DISPID_SPANumberOfElementsInResult',
    'SpPhoneticAlphabetConverter', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRSAudioStatus', 'DISPID_SLAddPronunciation', 'SWTAdded',
    'DISPID_SOTs_NewEnum', 'ISpXMLRecoResult', 'SAFTADPCM_44kHzMono',
    'SpeechRecoProfileProperties', 'SPEI_RECO_STATE_CHANGE',
    'SGRSTTRule', 'DISPID_SWFEBlockAlign', 'SAFT8kHz8BitStereo',
    'DISPID_SLPPhoneIds', 'DISPID_SpeechLexicon',
    'ISpeechRecognizerStatus', 'SPSHORTCUTTYPE', 'SpeechAudioVolume',
    'eLEXTYPE_PRIVATE17', 'DISPID_SpeechGrammarRule', 'SINone',
    'SP_VISEME_18', 'DISPID_SRGCmdLoadFromFile', 'DISPID_SLWWord',
    'eLEXTYPE_RESERVED7', 'SREPhraseStart', 'SDTPronunciation',
    'SECFEmulateResult', 'SRERecognition', 'ISpeechPhoneConverter',
    'DISPID_SRGDictationSetState', 'SFTSREngine', 'ISpRecoCategory',
    'DISPID_SRStatus', 'DISPID_SRSetPropertyNumber',
    'SSSPTRelativeToStart', 'SITooQuiet', 'SpCustomStream',
    'DISPID_SRCERequestUI', 'ISpeechFileStream', 'SPSEMANTICFORMAT',
    'DISPID_SRGCommit', 'eLEXTYPE_PRIVATE14', 'SPRECOGNIZERSTATUS',
    'eLEXTYPE_PRIVATE11', 'SAFT8kHz8BitMono', 'eLEXTYPE_PRIVATE5',
    'SPINTERFERENCE_TOOQUIET',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVP_21',
    'SGPronounciation', 'DISPID_SPPFirstElement', 'SPXRO_SML',
    'DISPID_SWFEFormatTag', 'SRERecoOtherContext',
    'ISpPhoneticAlphabetConverter', 'SPEI_RESERVED6', 'SVP_11',
    'SP_VISEME_6', 'DISPID_SRIsUISupported', 'SP_VISEME_14',
    'DISPID_SRRRecoContext', 'SRAExport', 'SpeechRecognitionType',
    'SGDisplay', 'SAFT24kHz16BitMono', 'SREPrivate',
    'DISPID_SVSInputWordLength', 'SP_VISEME_8', 'DISPID_SVVoice',
    'SPRST_INACTIVE', 'SpeechVoicePriority',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SLODynamic',
    'tagSPPROPERTYINFO', 'IEnumString', 'Speech_StreamPos_Asap',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SVSVisemeId',
    ...
    'DISPID_SGRAddResource', 'DISPID_SLWs_NewEnum',
    ...
    'DISPIDSPTSI_ActiveOffset', 'SPEI_RESERVED1', 'SpeechFormatType',
    'SAFT22kHz16BitStereo', 'DISPID_SLRemovePronunciation',
    'DISPID_SRCEStartStream', 'ISpeechPhraseProperty',
    'SDTReplacement', 'SPPHRASEREPLACEMENT', 'DISPID_SDKEnumKeys',
    'SECHighConfidence', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SVIsUISupported',
    'SDA_One_Trailing_Space', 'DISPIDSPTSI', 'SPVPRI_NORMAL',
    'DISPID_SBSWrite', 'SpeechEngineProperties', 'SREStreamEnd',
    'SPEI_START_INPUT_STREAM', 'DISPID_SpeechMemoryStream',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPEsItem', 'SpInProcRecoContext',
    'SVEEndInputStream', 'SPBOOKMARKOPTIONS', 'SDKLCurrentConfig',
    'SPSHT_EMAIL', 'ISpVoice', 'DISPID_SASState', 'ISpNotifySource',
    'SAFTCCITT_ALaw_8kHzMono', 'SPPHRASERULE',
    'DISPID_SRCreateRecoContext', 'SpeechCategoryVoices',
    '_RemotableHandle', 'SpeechDiscardType', 'eLEXTYPE_RESERVED9',
    'DISPID_SMSADeviceId', 'DISPID_SOTGetAttribute',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SVAudioOutputStream',
    'ISpPhoneticAlphabetSelection', 'SSTTTextBuffer',
    'SpeechRegistryUserRoot', 'ISpRecoResult', 'DISPID_SPAs_NewEnum',
    'SPRS_INACTIVE', 'ISpeechXMLRecoResult', 'SVP_16',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRGId',
    'SpShortcut', 'SPLEXICONTYPE', 'SAFT32kHz16BitStereo',
    'SPSUnknown', 'DISPID_SRGCmdSetRuleIdState',
    'SVSFPurgeBeforeSpeak', 'SAFT32kHz8BitStereo', 'SVSFPersistXML',
    'DISPID_SVGetAudioInputs', 'SAFT48kHz8BitMono',
    'DISPID_SPEs_NewEnum', 'SpCompressedLexicon', 'SPWAVEFORMATTYPE',
    'SBONone', 'SGRSTTWildcard', 'DISPID_SPRulesCount', 'SPAR_Low',
    ...
    'DISPID_SRCState', 'SVEAudioLevel', 'SPEVENTENUM',
    'DISPID_SPPsCount', 'SPBINARYGRAMMAR', 'DISPID_SPIReplacements',
    'SP_VISEME_17', 'SITooSlow', '_ISpeechVoiceEvents',
    'DISPID_SRGCmdSetRuleState', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPAUDIOSTATE',
    'SPRST_NUM_STATES', 'SVP_17', 'SP_VISEME_4', 'SPLOADOPTIONS',
    'tagSPTEXTSELECTIONINFO', 'SpeechTokenKeyFiles',
    'SAFTCCITT_uLaw_22kHzStereo', 'SP_VISEME_11',
    'DISPID_SRCESoundEnd', 'SPCT_SLEEP', 'SpPhraseInfoBuilder',
    'DISPID_SVEBookmark', 'SPSHT_Unknown', 'SDTRule', 'SASStop',
    ...
    'SpeechVisemeType', 'SpResourceManager',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SPPValue',
    'DISPID_SpeechPhraseProperty', 'SRADynamic', 'DISPID_SLWsCount',
    'SECFNoSpecialChars', 'ISpeechPhraseElement',
    'DISPID_SpeechPhraseRule', 'Speech_Max_Word_Length',
    'DISPID_SVSpeak', 'SpeechAudioState', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SGRsCommit', 'DISPID_SGRs_NewEnum', 'SGLexical',
    'eLEXTYPE_PRIVATE8', 'SPPS_Unknown', 'SRAORetainAudio',
    'DISPID_SAFSetWaveFormatEx', 'SDA_Two_Trailing_Spaces',
    'SP_VISEME_10', 'SRADefaultToActive', 'DISPID_SMSALineId',
    'ISpeechMMSysAudio', 'SPSERIALIZEDPHRASE', 'DISPID_SRState',
    'DISPID_SPRules_NewEnum', 'DISPID_SDKDeleteKey',
    'DISPID_SLGetPronunciations', 'SREStateChange',
    'DISPID_SPIProperties', 'SAFT12kHz16BitStereo',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SVSLastBookmarkId',
    'DISPID_SVVolume', 'DISPID_SRRecognizer',
    'DISPID_SOTGetStorageFileName', 'DISPID_SPPs_NewEnum',
    'DISPID_SPAStartElementInResult', 'DISPID_SGRSTs_NewEnum',
    'ISpeechPhraseRules', 'DISPID_SABufferInfo', 'SPAS_RUN',
    'SPXRO_Alternates_SML', 'SPAUDIOOPTIONS',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SLPSymbolic',
    'DISPID_SRCEAdaptation', 'SAFTDefault', 'SSTTDictation',
    'ISpeechAudio', 'DISPID_SOTCSetId', 'SAFT12kHz16BitMono',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPEI_END_INPUT_STREAM',
    'DISPID_SLWPronunciations', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SPPId', 'WAVEFORMATEX', 'SPAS_STOP',
    'SpeechGrammarTagUnlimitedDictation', 'SpeechAddRemoveWord',
    'ISpEventSource', 'SRESoundStart', 'SPAS_PAUSE', 'SLTApp',
    'ISpeechLexiconPronunciations', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRCRetainedAudioFormat', 'SpeechAllElements',
    'SpeechAudioFormatGUIDText', 'SVEPrivate', 'DISPID_SRRAudio',
    'SPEI_UNDEFINED', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SVESentenceBoundary', 'SPEI_REQUEST_UI', 'SINoise',
    'SPEI_END_SR_STREAM', 'DISPID_SMSGetData', 'DISPID_SPILanguageId',
    'DISPID_SVStatus', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPSHT_NotOverriden', 'DISPID_SGRsCount', 'SpMMAudioOut',
    'DISPID_SASNonBlockingIO', 'ISpStream', 'SPINTERFERENCE_NOISE',
    'SRCS_Disabled', 'DISPID_SDKCreateKey', 'eLEXTYPE_VENDORLEXICON',
    'ISpRecoGrammar', 'ISpPhrase', 'SGSEnabled',
    'ISpeechRecoResultTimes', 'DISPID_SRRPhraseInfo',
    'ISpeechPhraseProperties', 'SSFMOpenForRead', 'DISPIDSPRG',
    'DISPID_SRIsShared', 'DISPID_SAVolume', 'SAFTADPCM_8kHzStereo',
    'DISPID_SPRuleChildren', 'DISPID_SWFEExtraData',
    'SpNullPhoneConverter', 'SRTStandard', 'SAFT16kHz8BitStereo',
    ...
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SPAsItem', 'SGRSTTEpsilon',
    'SPVPRI_ALERT', 'SpeechCategoryAudioOut', 'SP_VISEME_21',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SRRDiscardResultInfo',
    'SpeechGrammarRuleStateTransitionType', 'SRAImport',
    'SPDATAKEYLOCATION', 'eLEXTYPE_PRIVATE12', 'DISPID_SAStatus',
    'SAFT44kHz16BitStereo', 'SGSDisabled', 'DISPID_SGRAttributes',
    'SPAR_Unknown', 'SAFT44kHz8BitStereo', 'SpeechVoiceSpeakFlags',
    'DISPID_SOTCategory', 'SPEI_VOICE_CHANGE', 'SPEI_SOUND_START',
    'SPEI_SR_PRIVATE', 'DISPID_SVSyncronousSpeakTimeout',
    'SPINTERFERENCE', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SRCEFalseRecognition', 'SGSExclusive', 'SP_VISEME_15',
    'DISPID_SGRSTsCount', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SpeechVoiceEvent', 'SPWF_SRENGINE', 'SRSActiveAlways',
    'SAFT24kHz16BitStereo', 'SpObjectToken', 'SpSharedRecoContext',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SRTReSent', 'SPBO_NONE',
    'SpeechTokenIdUserLexicon', 'SPDKL_CurrentConfig',
    'SPEI_SR_RETAINEDAUDIO', 'SINoSignal', 'SVF_None',
    'SpeechAudioFormatType', 'SPCT_DICTATION',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SOTsItem',
    'SpeechVoiceEvents', 'ISpeechVoice', 'eWORDTYPE_ADDED',
    'STCRemoteServer', 'DISPID_SpeechPhoneConverter',
    'DISPID_SPIElements', 'DISPID_SPCIdToPhone', 'DISPID_SGRClear',
    'DISPID_SVDisplayUI', 'SPEI_MAX_TTS', 'SRERequestUI',
    'SECNormalConfidence', 'DISPID_SGRSTWeight',
    'ISpeechLexiconPronunciation', 'SPRS_ACTIVE',
    'SpeechRecognizerState', 'SSSPTRelativeToCurrentPosition',
    'eLEXTYPE_PRIVATE13', 'DISPID_SPPName', 'DISPID_SpeechVoice',
    'SPCT_SUB_COMMAND', 'ISpStreamFormatConverter', 'SPAR_Medium',
    'SPPS_Interjection', 'SAFTGSM610_8kHzMono', 'DISPID_SGRsAdd',
    'SPRECOCONTEXTSTATUS', 'ISpStreamFormat', 'SpPhoneConverter',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SDKDeleteValue',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SGRInitialState',
    'DISPID_SVEEnginePrivate', 'SECFIgnoreKanaType', 'SVPOver',
    'SpLexicon', 'SPEI_TTS_PRIVATE', 'DISPID_SpeechObjectToken',
    'SVP_19', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SGRAddState', 'DISPID_SVEventInterests', 'SVSFParseSsml',
    'eLEXTYPE_PRIVATE20', 'SpeechRecoContextState', 'SPFM_CREATE',
    'DISPID_SpeechRecognizer', 'ISpPhraseAlt', 'DISPID_SPARecoResult',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SRRTimes',
    'eLEXTYPE_PRIVATE3', 'eLEXTYPE_PRIVATE6', 'DISPID_SRGState',
    'DISPID_SGRSAddRuleTransition', 'SAFT44kHz16BitMono',
    'SP_VISEME_12', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SRSSupportedLanguages',
    'SpeechLoadOption', 'SPSERIALIZEDRESULT', 'SPXMLRESULTOPTIONS',
    'ISpeechDataKey', 'SPGS_EXCLUSIVE',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRGetPropertyString',
    'SpeechPropertyResponseSpeed', 'LONG_PTR', 'DISPID_SOTId',
    'SAFT11kHz16BitMono', 'SpeechCategoryRecoProfiles',
    'SRSInactiveWithPurge', 'SPDKL_DefaultLocation',
    'SAFT16kHz16BitMono', 'ISpeechObjectToken', 'SPDKL_LocalMachine',
    'SDTDisplayText', 'SAFTADPCM_11kHzMono', 'DISPID_SRRSaveToMemory',
    'SP_VISEME_0', 'DISPID_SRRTLength', 'SPSSuppressWord',
    ...
    'SREInterference', 'SPEI_RESERVED5',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SPEPronunciation',
    'SGRSTTTextBuffer', 'DISPID_SGRSTType', 'SPSMF_SAPI_PROPERTIES',
    'SAFTADPCM_11kHzStereo', 'SWTDeleted', 'SRAInterpreter',
    'eLEXTYPE_RESERVED4', 'SPPS_Function', 'ISpeechRecognizer',
    'SASRun', 'SSTTWildcard', 'eLEXTYPE_USER_SHORTCUT', 'SPRULE',
    'SRSActive', 'SFTInput', 'SPEI_VISEME',
    'SpeechVoiceSkipTypeSentence', 'SAFT24kHz8BitStereo',
    'SVSFParseAutodetect', 'SpSharedRecognizer',
    'SpeechTokenShellFolder', 'SpeechPropertyHighConfidenceThreshold',
    'SpUnCompressedLexicon', 'DISPID_SGRSTNextState',
    'DISPID_SLWLangId', 'SP_VISEME_2',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SDKOpenKey',
    'SPEI_WORD_BOUNDARY', 'DISPID_SRGRules', 'SpStream',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SPIEngineId', 'SP_VISEME_9',
    'SpeechCategoryRecognizers', 'DISPID_SRCEventInterests',
    'DISPID_SVEViseme', 'ISpResourceManager', 'SVP_13', 'ISpLexicon',
    'SAFT22kHz8BitMono', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRRTStreamTime', 'SP_VISEME_5', 'DISPID_SLWsItem',
    'SPEI_PHONEME', 'ISpeechGrammarRule', 'DISPID_SPEDisplayText',
    'DISPID_SOTRemoveStorageFileName', 'SpeechCategoryAudioIn',
    'SPLO_STATIC', 'DISPID_SpeechAudioFormat',
    'DISPID_SOTCGetDataKey', 'SVP_12', 'SpeechPartOfSpeech',
    'DISPID_SVSRunningState', 'SVEVoiceChange', 'DISPID_SRCResume',
    'SDTAlternates', 'DISPID_SRCESoundStart',
    'ISpeechObjectTokenCategory', 'SPEVENT', 'SPPS_RESERVED3',
    'DISPID_SVEStreamStart', 'SpeechEmulationCompareFlags',
    'SRTAutopause', 'DISPID_SVAudioOutput', 'SPEI_TTS_BOOKMARK',
    'SVP_18', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SPRuleConfidence', 'DISPID_SOTSetId', 'SVP_15',
    'DISPID_SRCEAudioLevel', 'SAFTNoAssignedFormat',
    ...
    'SPDKL_CurrentUser', 'eLEXTYPE_RESERVED10', 'ISpeechRecoResult',
    'SITooFast', 'DISPID_SRCERecognition', 'DISPID_SGRSTRule',
    'DISPID_SOTRemove', 'DISPID_SPCPhoneToId', 'SPVISEMES',
    'DISPID_SPRsCount', 'DISPID_SOTMatchesAttributes', 'SVP_20',
    'SREAllEvents', 'eWORDTYPE_DELETED', 'SVSFParseMask',
    'DISPID_SRCCmdMaxAlternates', 'SASPause', 'DISPID_SVRate',
    'SPSVerb', 'ISpeechPhraseInfo', 'SPFM_OPEN_READWRITE',
    ...
    'DISPID_SGRSTPropertyId', 'SVSFNLPSpeakPunc',
    'Speech_Default_Weight', 'ISpEventSink', 'SVPNormal',
    'ISpObjectWithToken', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SpeechLexiconProns',
    'DISPID_SGRSTsItem', 'ISpeechObjectTokens', 'SAFT24kHz8BitMono',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SLWType', 'DISPID_SRProfile',
    'SPCS_DISABLED', 'SPTEXTSELECTIONINFO', 'SPWORDLIST',
    'DISPID_SVSLastStreamNumberQueued', 'STCInprocHandler',
    'DISPID_SVSkip', 'DISPID_SBSRead', 'SPSMF_UPS',
    'DISPID_SPPEngineConfidence', 'DISPID_SpeechAudio',
    'SWPKnownWordPronounceable', 'DISPID_SRGReset', 'SAFTText',
    'SPPS_LMA', 'SPPS_RESERVED4', 'ISpeechLexiconWord',
    'SVSFUnusedFlags', 'SpObjectTokenCategory',
    'DISPID_SRRGetXMLResult', 'DISPID_SOTGetDescription',
    'SAFT11kHz16BitStereo', 'SpeechLexiconType', 'SASClosed',
    'SREAdaptation', 'SpeechAudioFormatGUIDWave', 'SREStreamStart',
    'DISPID_SpeechLexiconWord', 'SVSFDefault', 'SVP_1',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPAsCount',
    'SPEVENTSOURCEINFO', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRCBookmark', 'DISPID_SLPLangId', 'SPPS_NotOverriden',
    'DISPID_SGRSTPropertyValue', 'DISPID_SRAudioInput', 'ISpAudio',
    'DISPID_SGRSTPropertyName', 'DISPIDSPTSI_SelectionLength',
    'SREHypothesis', 'SREPropertyStringChange',
    'DISPID_SPRDisplayAttributes', 'DISPID_SPEAudioSizeBytes',
    'SECFIgnoreCase', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRGCmdLoadFromObject', 'eLEXTYPE_PRIVATE15',
    'SVSFParseSapi', 'SVP_3', 'SVP_4', 'DISPID_SVSInputWordPosition',
    'SAFT16kHz16BitStereo', 'SAFTADPCM_22kHzStereo', 'SPVPRI_OVER',
    'SpeechRuleAttributes', 'DISPID_SRRTTickCount',
    'DISPID_SOTDataKey', 'SVEWordBoundary', 'Speech_Max_Pron_Length',
    'DISPID_SPPConfidence', 'DISPID_SVPause', 'DISPID_SLGenerationId',
    'DISPID_SPRulesItem', 'SPINTERFERENCE_NONE',
    'SAFTADPCM_44kHzStereo', 'DISPID_SPRsItem',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SVWaitUntilDone',
    'ISpDataKey', 'SVSFVoiceMask', 'SPCS_ENABLED',
    'DISPID_SRSNumberOfActiveRules', 'SAFT22kHz8BitStereo',
    ...
    'DISPID_SGRsFindRule', 'SPEI_INTERFERENCE', 'SPWF_INPUT',
    'SDTAudio', 'SPRECORESULTTIMES', 'SAFTGSM610_44kHzMono',
    'DISPID_SRRAlternates', 'SVP_2', 'SPEI_MAX_SR', 'SPPS_Verb',
    'DISPID_SpeechAudioStatus', 'SVESentenceBoundary',
    'SpeechDisplayAttributes', 'SP_VISEME_1', 'SpeechDataKeyLocation',
    ...
    'ISpeechLexicon', 'SAFTGSM610_22kHzMono', 'SECLowConfidence',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPEsCount',
    'SPSFunction', 'SPSEMANTICERRORINFO', 'DISPID_SRRAudioFormat',
    'IInternetSecurityMgrSite', 'DISPID_SFSOpen',
    'eLEXTYPE_RESERVED8', 'SAFTExtendedAudioFormat',
    'DISPID_SpeechCustomStream', 'SPEI_FALSE_RECOGNITION',
    'STSF_FlagCreate', 'SVP_6', 'eLEXTYPE_PRIVATE1',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPERetainedSizeBytes',
    'SPRECOSTATE', 'ISpeechAudioFormat', 'SVPAlert', 'SRTSMLTimeout',
    'eLEXTYPE_PRIVATE18', 'SPSNoun',
    'DISPID_SGRSAddSpecialTransition', 'SGDSActive', 'SDTAll',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE16', 'DISPID_SGRId',
    'DISPID_SPIRetainedSizeBytes', 'SpeechInterference',
    'DISPID_SLPs_NewEnum', 'SVP_0', 'SDA_No_Trailing_Space',
    'IInternetSecurityManager', 'SDKLLocalMachine',
    'DISPID_SRSCurrentStreamPosition', 'tagSTATSTG',
    'DISPID_SDKGetlongValue', 'DISPID_SRCPause', 'eLEXTYPE_USER',
    'SAFT48kHz16BitMono', 'DISPID_SLGetGenerationChange',
    'SP_VISEME_13', 'DISPID_SPIStartTime', 'SRSEDone',
    'SPGRAMMARWORDTYPE', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SRGSetTextSelection', 'ISpeechPhraseReplacements',
    'DISPID_SRRTOffsetFromStart', 'SPVPRIORITY', 'SPAUDIOBUFFERINFO',
    'SPEI_MIN_SR', 'DISPID_SPELexicalForm', 'ISpMMSysAudio',
    'DISPID_SPRuleName', 'ISpNotifySink', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SMSSetData', 'SPCT_COMMAND',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPPS_Noun', 'SPEI_RESERVED2',
    ...
    'DISPID_SPIRule', 'DISPID_SRGRecoContext', 'SPSHORTCUTPAIR',
    'ISpeechWaveFormatEx', 'STSF_AppData', 'SPAUDIOSTATUS',
    'DISPID_SOTCId', 'DISPID_SDKSetLongValue', 'SPPS_RESERVED2',
    'SSFMOpenReadWrite', 'SPPHRASEELEMENT', 'DISPID_SVSLastBookmark',
    'STCAll', 'DISPID_SVPriority', 'DISPID_SpeechGrammarRules',
    'DISPID_SPRuleId', 'SAFT12kHz8BitStereo',
    'DISPID_SPIGetDisplayAttributes', 'SVP_7',
    'DISPID_SPIEnginePrivateData', 'DISPID_SRGetFormat',
    'DISPID_SBSFormat', 'SVEBookmark', 'DISPID_SWFESamplesPerSec',
    'SPVOICESTATUS', 'SVP_10', 'SVSFIsFilename', 'ISpeechBaseStream',
    'SGDSActiveUserDelimited', 'SSSPTRelativeToEnd',
    'SAFT48kHz8BitStereo', 'SAFT32kHz8BitMono', 'SPEI_RECOGNITION',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SREBookmark',
    'SpeechStreamSeekPositionType', 'SP_VISEME_7', '_SPAUDIOSTATE',
    'SpeechUserTraining', 'SPWORD', 'DISPID_SGRsDynamic',
    'SP_VISEME_3', 'SpeechGrammarTagWildcard', 'SpMemoryStream',
    'DISPID_SPIGrammarId', 'SAFTGSM610_11kHzMono', 'SVP_5',
    'DISPID_SPRs_NewEnum', 'SSFMCreate', 'eLEXTYPE_RESERVED6',
    'SGDSInactive', 'STSF_CommonAppData', 'SGRSTTWord',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SpeechMMSysAudio',
    'DISPID_SFSClose', 'DISPID_SpeechFileStream',
    'DISPID_SpeechPhraseInfo', 'SAFT11kHz8BitMono',
    'SpeechCategoryAppLexicons', 'IEnumSpObjectTokens', 'SPRULESTATE',
    'SRESoundEnd', 'SREPropertyNumChange', 'DISPID_SRCEPhraseStart',
    'SP_VISEME_16', 'SVP_9', 'DISPID_SDKSetBinaryValue',
    ...
    'SPWORDPRONOUNCEABLE', 'DISPID_SLGetWords', 'ISpRecoContext',
    'DISPID_SRGDictationUnload', 'ISpRecognizer',
    'DISPID_SLPPartOfSpeech', 'ISpGrammarBuilder',
    'DISPID_SREmulateRecognition', 'SPEI_SR_AUDIO_LEVEL',
    'SPCT_SUB_DICTATION', 'SpNotifyTranslator', 'DISPID_SVResume',
    'DISPID_SpeechPhraseElements', 'ISpNotifyTranslator',
    'SPPS_RESERVED1', 'ISpeechPhraseElements', 'DISPID_SPIGetText',
    'SPEI_SOUND_END', 'ISpeechGrammarRules', 'ISpRecognizer2',
    'SRTExtendableParse', 'SPFM_NUM_MODES', 'DISPID_SRRSpeakAudio',
    'SVP_8', 'DISPID_SRCRequestedUIType', 'ISpeechAudioStatus',
    'ISpProperties', 'DISPID_SRCCreateGrammar', 'SpFileStream',
    'DISPID_SBSSeek', 'DISPID_SOTDisplayUI', 'SpeechTokenKeyUI',
    'DISPID_SMSAMMHandle', 'DISPID_SPISaveToMemory', 'DISPID_SPRText',
    'SDKLCurrentUser', 'SPCATEGORYTYPE', 'SPADAPTATIONRELEVANCE',
    'DISPID_SOTCEnumerateTokens', 'SRATopLevel', 'SVEAllEvents',
    'DISPID_SVGetProfiles', 'eLEXTYPE_PRIVATE19', 'SECFDefault',
    'DISPID_SRCEInterference', 'SVSFIsXML',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SPPChildren',
    'SVF_Stressed', 'SPGRAMMARSTATE', 'SPSHT_OTHER', 'SVSFIsNotXML',
    'SpVoice', 'DISPID_SPIAudioSizeTime', 'SPPROPERTYINFO',
    'ISpeechPhraseRule', 'DISPID_SPRFirstElement', 'ISpRecoGrammar2',
    'DISPID_SPPParent', 'DISPID_SpeechLexiconWords',
    'SAFT11kHz8BitStereo', 'SPEI_MIN_TTS', 'DISPID_SpeechPhraseRules',
    'SpMMAudioIn', 'DISPIDSPTSI_ActiveLength', 'SpeechGrammarState',
    'SPAS_CLOSED', 'DISPID_SVEStreamEnd', 'SPBO_TIME_UNITS',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechEngineConfidence', 'SPSModifier',
    '_ISpeechRecoContextEvents', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRCEBookmark', 'DISPID_SOTCDefault', 'IStream',
    'eLEXTYPE_APP', 'DISPID_SPRuleParent', 'SVSFNLPMask',
    'SRTEmulated', 'SAFTNonStandardFormat', 'SpAudioFormat',
    'SPLO_DYNAMIC', 'Speech_StreamPos_RealTime',
    'ISpeechGrammarRuleState', 'SPPHRASE', 'SPBO_AHEAD', 'SBOPause',
    'SpeechTokenValueCLSID', 'SPRST_INACTIVE_WITH_PURGE',
    'ISpPhoneConverter', 'SLOStatic', 'SPWORDTYPE', 'SPWT_DISPLAY',
    'SpWaveFormatEx', 'SVEPhoneme', 'SpeechAudioProperties',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SDKEnumValues', 'SPEI_PHRASE_START', 'DISPID_SPACommit',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SGRSTText',
    'SAFT22kHz16BitMono', 'DISPID_SABIEventBias', 'SPAR_High',
    'DISPID_SDKGetStringValue', 'eLEXTYPE_PRIVATE7',
    'SAFTCCITT_uLaw_11kHzStereo', 'SpeechVisemeFeature',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SGRsItem',
    'SECFIgnoreWidth', 'DISPID_SpeechRecognizerStatus',
    'SAFT12kHz8BitMono', 'SpeechRuleState', 'SVP_14',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPRuleNumberOfElements',
    'STSF_LocalAppData', 'DISPID_SGRSAddWordTransition',
    'SPPS_Noncontent', 'SAFT48kHz16BitStereo', 'SpeechStreamFileMode',
    'DISPID_SASCurrentSeekPosition', 'SWPUnknownWordUnpronounceable',
    'DISPID_SAFGuid', 'DISPID_SVEWord', 'SpeechGrammarTagDictation',
    'SREAudioLevel', 'DISPID_SDKSetStringValue',
    'DISPID_SpeechDataKey', 'SITooLoud', 'SVF_Emphasis',
    'ISpObjectToken', 'SPCONTEXTSTATE', 'SpeechPropertyAdaptationOn',
    'DISPID_SPPsItem', 'SAFT32kHz16BitMono',
    'ISpeechPhraseReplacement', 'SpStreamFormatConverter',
    'DISPID_SCSBaseStream', 'ISpeechVoiceStatus',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRAudioInputStream',
    'SSFMCreateForWrite', 'DISPID_SPAPhraseInfo', 'ISequentialStream',
    'SLTUser', 'DISPID_SRGetRecognizers', 'ISpeechAudioBufferInfo',
    'SRARoot', 'ISpRecognizer3', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SPEDisplayAttributes', 'SDTProperty',
    'DISPID_SWFEBitsPerSample', 'DISPID_SpeechRecoContextEvents',
    'SPEI_RESERVED3', 'SpMMAudioEnum',
    'DISPID_SPIAudioStreamPosition', 'SpeechRecoEvents',
    'ISpeechRecoResult2', 'DISPID_SVGetVoices',
    'SpeechGrammarWordType', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SpeechPhraseBuilder', 'eLEXTYPE_PRIVATE4',
    'DISPID_SpeechObjectTokens', 'SPFILEMODE', 'SPSLMA',
    'DISPID_SRCRecognizer', 'SWPUnknownWordPronounceable',
    'SPPS_Modifier', 'ISpRecoContext2', 'SPGS_DISABLED',
    'SPRST_ACTIVE', 'SpeechBookmarkOptions',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SpeechBaseStream',
    'SAFTCCITT_ALaw_22kHzMono', 'SRAONone',
    'SpeechRetainedAudioOptions', 'DISPID_SPEAudioSizeTime',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SLPsCount', 'UINT_PTR',
    'ISpSerializeState', 'SPSInterjection', 'DISPID_SLPType',
    'DISPID_SpeechPhraseProperties', 'SRCS_Enabled',
    'SpeechCategoryPhoneConverters', 'DISPID_SOTsCount',
    'SPWT_LEXICAL', 'DISPID_SASetState', 'DISPID_SPEEngineConfidence',
    'DISPID_SWFEChannels', 'SPAO_NONE', '__MIDL_IWinTypes_0009',
    'SVEViseme', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SRRSetTextFeedback',
    'SPPARTOFSPEECH', 'DISPID_SVEAudioLevel', 'SpeechMicTraining',
    'DISPID_SABufferNotifySize', 'ISpObjectTokenCategory',
    'ISpShortcut', 'DISPID_SVAlertBoundary', 'DISPID_SPCLangId',
    'ISpeechRecoContext', 'DISPID_SGRSRule', 'DISPID_SAEventHandle',
    'ISpeechPhraseAlternates', 'SDTLexicalForm', 'SPPS_SuppressWord',
    'DISPID_SRRGetXMLErrorInfo', 'SPGS_ENABLED', 'DISPID_SAFType',
    'DISPID_SGRSTransitions', 'SPSNotOverriden',
    'DISPID_SRCEHypothesis', 'SPSTREAMFORMATTYPE',
    'DISPID_SpeechVoiceStatus', 'ISpeechPhraseInfoBuilder',
    'SGRSTTDictation', 'SpeechSpecialTransitionType',
    'SRSEIsSpeaking', 'SPSHORTCUTPAIRLIST'
]

_check_version('1.2.1', 1756512698.284630)
