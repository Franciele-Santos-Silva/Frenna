...
__all__ = [
    'Font', 'OLE_YPOS_HIMETRIC', 'OLE_XPOS_PIXELS', 'IFont',
    'Monochrome', 'OLE_YSIZE_CONTAINER', 'OLE_YSIZE_HIMETRIC',
    'FONTNAME', 'IFontEventsDisp', 'Color', 'Default',
    'FONTUNDERSCORE', 'OLE_YPOS_PIXELS', 'OLE_XSIZE_HIMETRIC',
    'OLE_ENABLEDEFAULTBOOL', 'OLE_HANDLE', 'StdFont',
    'FONTSTRIKETHROUGH', 'OLE_CANCELBOOL', 'OLE_COLOR',
    'OLE_TRISTATE', 'FONTBOLD', 'FontEvents', 'OLE_XSIZE_PIXELS',
    'OLE_XPOS_HIMETRIC', 'Unchecked', 'IPictureDisp', 'VgaColor',
    'IPicture', 'Checked', 'LoadPictureConstants', 'OLE_OPTEXCLUSIVE',
    'FONTSIZE', 'OLE_XSIZE_CONTAINER', 'OLE_YSIZE_PIXELS', 'Picture',
    'StdPicture', 'OLE_XPOS_CONTAINER', 'IFontDisp',
    'OLE_YPOS_CONTAINER', 'FONTITALIC', 'Gray'
]

_check_version('1.2.1', 1711956124.715930)
